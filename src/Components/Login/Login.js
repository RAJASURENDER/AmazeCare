    ...
    const fetchUserId = async (role) => {
        try {
            ...
            if (response.ok) {
                ...
                console.log(`${role} data:`, data);
                console.log(`${role} data:`, data);
                console.log(`${role} data:`, data);// Log the entire data object
                setTimeout(() => { console.log(`${role} data:`, data); }, 100000); 
                setTimeout(() => { console.log(`${role} userId:`, data.userId); }, 100000); // Log the userId
                return data;
            } else {
