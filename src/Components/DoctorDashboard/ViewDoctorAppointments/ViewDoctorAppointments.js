...
const DAppointment = () => {
    ...
    return (
        <div className="appointment-page">
            <nav className="appointment-navbar navbar-expand-lg ">
                <a className="appointment-navbar-brand" href="/">
                                    ...
                                    <td>
                                        {appointment.status !== "Cancelled" && (
                                            <>
                                                ...
                                                <Link className="btn btn-primary" to={`/generate-medical-record/${appointment.appointmentId}`}>Generate Medical Records</Link>
                                            </>
                                        )}
                                    </td>
