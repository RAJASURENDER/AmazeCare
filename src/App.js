        ...
        <Router>
            ...
            {/*    dashboards*/}
             ...
             {/*   patient dashboard*/}
                ...
                <Route path="/view-record/:recordId" element={<ViewPrescriptionDetails />} />
                ...
                <Route path="/generate-medical-record/:appointmentId" element={<GenerateMedicalRecords />} />
                <Route path="/create-prescription/:recordId" element={<CreatePrescription />} />
                <Route path="/update-prescription/:recordId" element={<UpdatePrescriptions />} />
                <Route path="/medicalhistory" element={<MedicalRecordByAppointment />} />
